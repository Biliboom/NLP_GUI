...
def bert_rf(filepath, test=False):
    ...
    with open(f'Your_Pickle/Random Forest/{savename}.pickle', 'wb') as handle:
        pickle.dump(rf_model, handle)                                     #Save the model to Your_Pickle folder (pickle folder for user uploaded datafiles)
