...
from cleaning_for_GUI import convert
from cleaning_for_GUI import splitter
...
def bert_xgboost(filepath, test=False):
    ...
    with open(f'Your_Pickle/XGBoost/{savename}.pickle', 'wb') as handle:
        pickle.dump(xgb_model, handle)                                    #Save the model to Your_Pickle folder (pickle folder for user uploaded datafiles)
